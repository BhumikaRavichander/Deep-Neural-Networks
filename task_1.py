...
model_0_1 = create_model(hidden_nodes=32)

model_0_1.compile(optimizer=tf.keras.optimizers.SGD(learning_rate=0.1),loss='sparse_categorical_crossentropy',metrics=['accuracy'])
model_0_1.fit(X_train,y_train,epochs=100,verbose=3)

training_loss_0_1 = model_0_1.history.history['loss']
xlabel = 'Epochs'
ylabel = 'Training Loss'
title = 'Training Loss - Learning Rate 0.1'
...
xlabel = 'Digits'
ylabel = 'Accuracy(%)'
title = 'Task1 - Accuracy Plot - learning rate - ' + str(learning_rate)
name = 'task1_acc_plot_'+str(learning_rate)+'.jpg'
...
model_0_01 = create_model(hidden_nodes=32)
...
model_0_01.fit(X_train,y_train,epochs=100,verbose=3)

training_loss_0_01 = model_0_01.history.history['loss']
xlabel = 'Epochs'
ylabel = 'Training Loss'
title = 'Training Loss - Learning Rate 0.01'
...
model_0_001 = create_model(hidden_nodes=32)
...
model_0_001.fit(X_train,y_train,epochs=100,verbose=3)

training_loss_0_001 = model_0_001.history.history['loss']
xlabel = 'Epochs'
ylabel = 'Training Loss'
title = 'Training Loss - Learning Rate 0.001'
